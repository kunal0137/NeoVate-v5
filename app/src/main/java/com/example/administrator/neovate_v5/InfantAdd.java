...
public class InfantAdd extends Activity{
    ...
    public void newInfant(View view){
        ...
        if( (name.isEmpty())){
            ...
            Intent intent2 = new Intent(InfantAdd.this, InfantList.class);
